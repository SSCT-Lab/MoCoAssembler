...
class DeConv(nn.Layer):
    def __init__(self, nIn, nOut, kSize, stride, padding, output_padding, dilation=(1, 1), groups=1, bn_acti=False):
        ...
        self.conv = nn.Conv2DTranspose(nIn, nOut, kernel_size=kSize, stride=stride, padding=padding,
...
class Conv(nn.Layer):
    def __init__(self, nIn, nOut, kSize, stride, padding, dilation=(1, 1), groups=1, bn_acti=False):
        super().__init__()
...
class CFPModule(nn.Layer):
    ...
    def forward(self, input):
        ...
        output_1 = paddle.concat([o1_1, o1_2, o1_3], 1)
        output_2 = paddle.concat([o2_1, o2_2, o2_3], 1)
        output_3 = paddle.concat([o3_1, o3_2, o3_3], 1)
        output_4 = paddle.concat([o4_1, o4_2, o4_3], 1)

        ad1 = output_1
        ad2 = ad1 + output_2
        ad3 = ad2 + output_3
        ad4 = ad3 + output_4
        output = paddle.concat([ad1, ad2, ad3, ad4], 1)
...
class CFPNet(nn.Layer):
    def __init__(self, classes=11, block_1=2, block_2=6):
        ...
        for i in range(0, block_1):
            self.CFP_Block_1.add_sublayer("CFP_Module_1_" + str(i), CFPModule(64, d=dilation_block_1[i]))
        ...
        for i in range(0, block_2):
            self.CFP_Block_2.add_sublayer("CFP_Module_2_" + str(i),
