...
class BasicBlock(torch.nn.Module):
    def __init__(self, in_planes, out_planes, stride, dropRate=0.0):
        ...
        self.convShortcut = (not self.equalInOut) and torch.nn.Conv2d(in_planes, out_planes, kernel_size=1,
                                                                      stride=stride,
...
class WideResNet(torch.nn.Module):
    def __init__(self, depth, num_classes, widen_factor=1, dropRate=0.0):
        ...
        self.conv1 = torch.nn.Conv2d(3, nChannels[0], kernel_size=3, stride=1,
                                     padding=1, bias=False)
        # 1st block
        ...
        self.fc = torch.nn.Linear(nChannels[3], num_classes)
