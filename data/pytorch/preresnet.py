...
class Bottleneck(torch.nn.Module):
    ...
    def __init__(self, inplanes, planes, cfg, stride=1, downsample=None):
        ...
        self.conv1 = torch.nn.Conv2d(cfg[0], cfg[1], kernel_size=1, bias=False)
        self.bn2 = torch.nn.BatchNorm2d(cfg[1])
        self.conv2 = torch.nn.Conv2d(cfg[1], cfg[2], kernel_size=3, stride=stride,
                               padding=1, bias=False)
        self.bn3 = torch.nn.BatchNorm2d(cfg[2])
        self.conv3 = torch.nn.Conv2d(cfg[2], planes * 4, kernel_size=1, bias=False)
