...
class Recurrent_block(torch.nn.Module):
...
class RRCNN_block(torch.nn.Module):
    def __init__(self, ch_in, ch_out, t=2):
        ...
        self.Conv_1x1 = torch.nn.Conv2d(ch_in, ch_out, kernel_size=1, stride=1, padding=0)
...
class U_Net(torch.nn.Module):
    def __init__(self, img_ch=3, output_ch=1):
        ...
        self.Conv_1x1 = torch.nn.Conv2d(64, output_ch, kernel_size=1, stride=1, padding=0)
...
class AttU_Net(torch.nn.Module):
    def __init__(self, img_ch=3, output_ch=1):
...
class R2AttU_Net(torch.nn.Module):
    def __init__(self, img_ch=3, output_ch=1, t=2):
