...
class InceptionAux(torch.nn.Module):
    def __init__(self, in_channels, out_channels):
        ...
        self.auxiliary_linear1 = torch.nn.Linear(in_features=128 * 4 * 4, out_features=1024)
        self.auxiliary_relu = torch.nn.ReLU6(inplace=True)
        self.auxiliary_dropout = torch.nn.Dropout(p=0.7)
        self.auxiliary_linear2 = torch.nn.Linear(in_features=1024, out_features=out_channels)
