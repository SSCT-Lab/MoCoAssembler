...
class Inception_Stem(tf.keras.layers.Layer):
    def __init__(self, input_shape=(32, 32, 3)):
        ...
        self.branch7x7a = tf.keras.Sequential([
            BasicConv2D(64, (1, 1)),
        ...
        self.branch7x7b = tf.keras.Sequential([
            BasicConv2D(64, (1, 1)),
            BasicConv2D(96, (3, 3), padding='same')
        ])
...
class InceptionA(tf.keras.layers.Layer):
    def __init__(self):
        ...
        self.branch3x3stack = tf.keras.Sequential([
            BasicConv2D(64, (1, 1)),
            BasicConv2D(96, (3, 3), padding='same'),
            BasicConv2D(96, (3, 3), padding='same')
        ])
        ...
        self.branchpool = tf.keras.Sequential([
...
class InceptionB(tf.keras.layers.Layer):
    def __init__(self):
        ...
        self.branch7x7stack = tf.keras.Sequential([
            BasicConv2D(192, (1, 1)),
            tf.keras.layers.ZeroPadding2D((0, 3)),
            BasicConv2D(192, (1, 7)),
            tf.keras.layers.ZeroPadding2D((3, 0)),
...
class InceptionC(tf.keras.layers.Layer):
    def __init__(self):
        ...
        self.branch3x3stacka = tf.keras.Sequential([
            tf.keras.layers.ZeroPadding2D((0, 1)),
            BasicConv2D(256, (1, 3))
        ])
        self.branch3x3stackb = tf.keras.Sequential([
            tf.keras.layers.ZeroPadding2D((1, 0)),
            BasicConv2D(256, (3, 1))
        ])

        self.branch3x3 = BasicConv2D(384, (1, 1))
        self.branch3x3a = tf.keras.Sequential([
            tf.keras.layers.ZeroPadding2D((1, 0)),
            BasicConv2D(256, (3, 1))
        ])
        self.branch3x3b = tf.keras.Sequential([
            tf.keras.layers.ZeroPadding2D((0, 1)),
            BasicConv2D(256, (1, 3))
        ])
