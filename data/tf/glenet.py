...
class InvertedResidualBlock(tf.keras.layers.Layer):
    def __init__(self, filters_in=32, filters_out=16, kernel_size=3, strides=1, expand_ratio=1, se_ratio=0.25,
                 name="stage2"):
        ...
        self.conv_layer1 = tf.keras.models.Sequential([
            tf.keras.layers.Conv2D(filters, 1, use_bias=False, kernel_initializer=KERNEL_INITIALIZER,
                                   kernel_regularizer=KERNEL_REGULARUZER),
            tf.keras.layers.BatchNormalization(),
            SwichActivation(),
            tf.keras.layers.DepthwiseConv2D(kernel_size, strides, padding='same', use_bias=False,
        ...
        self.se_conv = tf.keras.models.Sequential([
            ...
            tf.keras.layers.Conv2D(filters_se, 1, use_bias=False, kernel_initializer=KERNEL_INITIALIZER,
                                   kernel_regularizer=KERNEL_REGULARUZER),
            SwichActivation(),
            tf.keras.layers.Conv2D(filters, 1, use_bias=False, kernel_initializer=KERNEL_INITIALIZER,
                                   kernel_regularizer=KERNEL_REGULARUZER),
        ...
        self.conv_layer2 = tf.keras.models.Sequential([
            tf.keras.layers.Conv2D(filters_out, 1, use_bias=False, kernel_initializer=KERNEL_INITIALIZER,
                                   kernel_regularizer=KERNEL_REGULARUZER),
            tf.keras.layers.BatchNormalization()
        ])
...
class GEN(tf.keras.layers.Layer):
    ...
    def __init__(self, **kwargs):
        ...
        self.conv1 = tf.keras.models.Sequential([
            tf.keras.layers.Conv2D(16, 5, padding='same', use_bias=False, kernel_initializer=KERNEL_INITIALIZER,
                                   kernel_regularizer=KERNEL_REGULARUZER),
            tf.keras.layers.BatchNormalization(),
            SwichActivation()
        ])
        ...
        self.conv2 = tf.keras.models.Sequential([
            tf.keras.layers.Conv2D(768, 1, use_bias=False, kernel_initializer=KERNEL_INITIALIZER,
                                   kernel_regularizer=KERNEL_REGULARUZER, name='GEN_stage6_conv'),
            tf.keras.layers.BatchNormalization(),
            SwichActivation(),
            tf.keras.layers.GlobalAveragePooling2D(),
            tf.keras.layers.Dense(768, use_bias=False, kernel_initializer=KERNEL_INITIALIZER,
                                  kernel_regularizer=KERNEL_REGULARUZER),
            tf.keras.layers.Activation('sigmoid'),
...
class LEN(tf.keras.Model):
    def __init__(self, **kwargs):
        ...
        self.last_conv = tf.keras.layers.Conv2D(3, 5, padding='same', use_bias=False,
...
class GleNet(tf.keras.Model):
    def __init__(self, backbone='GEN', low_size=[256, 256], use_local=True, **kwargs):
