...
class InceptionE(tf.keras.layers.Layer):
    def __init__(self):
        ...
        self.branch3x3_2a = tf.keras.Sequential([
            tf.keras.layers.ZeroPadding2D((0, 1)),
            BasicConv2D(384, (1, 3))
        ])
        self.branch3x3_2b = tf.keras.Sequential([
        ...
        self.branch3x3stack_3a = tf.keras.Sequential([
            tf.keras.layers.ZeroPadding2D((0, 1)),
            BasicConv2D(384, (1, 3))
        ])
        self.branch3x3stack_3b = tf.keras.Sequential([
            tf.keras.layers.ZeroPadding2D((1, 0)),
            BasicConv2D(384, (3, 1))
        ])
