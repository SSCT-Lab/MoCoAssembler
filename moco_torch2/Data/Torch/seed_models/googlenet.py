...
class Inception(nn.Module):
    def __init__(self, in_channels, ch1x1, ch3x3red, ch3x3, ch5x5red, ch5x5, pool_proj):
        ...
        self.conv1 = torch.nn.Conv2d(in_channels=in_channels, out_channels=ch1x1, kernel_size=1)

        self.conv2a = torch.nn.Conv2d(in_channels=in_channels, out_channels=ch3x3red, kernel_size=1, stride=1)
        self.conv2b = torch.nn.Conv2d(in_channels=ch3x3red, out_channels=ch3x3, kernel_size=3, stride=1, padding=1)

        self.conv3a = torch.nn.Conv2d(in_channels=in_channels, out_channels=ch5x5red, kernel_size=1, stride=1)
        self.conv3b = torch.nn.Conv2d(in_channels=ch5x5red, out_channels=ch5x5, kernel_size=5, stride=1, padding=2)

        self.conv4 = torch.nn.Conv2d(in_channels=in_channels, out_channels=pool_proj, kernel_size=1, stride=1)
        self.cat = torch.cat
