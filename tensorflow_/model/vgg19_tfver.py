...
def VGG19(class_num=1000, input_shape=(224, 224, 3)):
    ...
    x = layers.Conv2D(filters=256, kernel_size=3, strides=1, activation="relu", padding="same", name="conv3d")(x)
    ...
    x = layers.Conv2D(filters=512, kernel_size=3, strides=1, activation="relu", padding="same", name="conv4d")(x)
    ...
    x = layers.Conv2D(filters=512, kernel_size=3, strides=1, activation="relu", padding="same", name="conv5d")(x)
