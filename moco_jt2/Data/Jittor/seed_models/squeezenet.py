...
class SqueezeNet(nn.Module):
    def __init__(self):
        ...
        self.concat2 = jittor.concat
        self.concat3 = jittor.concat
        self.concat4 = jittor.concat
        self.concat5 = jittor.concat
        self.concat6 = jittor.concat
        self.concat7 = jittor.concat
        self.concat8 = jittor.concat
        self.concat9 = jittor.concat
