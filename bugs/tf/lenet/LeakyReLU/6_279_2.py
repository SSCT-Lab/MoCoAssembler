...
# lenet hidden layer
    ...
    x = keras.layers.Conv2DTranspose(filters=32, kernel_size=5, activation="relu", padding="same", dilation_rate=6)(x)
    x = keras.layers.LeakyReLU(alpha=-0.27315541042255376)(x)
# lenet output layer
