...
# lenet hidden layer
    x = keras.layers.Conv2D(filters=6, kernel_size=6, strides=1, activation="relu", padding="valid")(input_tensor)
    x = keras.layers.GlobalAveragePooling2D(keepdims=True)(x)
    x = keras.layers.ActivityRegularization(l1=0.730725836613348, l2=-0.6356242051367522)(x)
# lenet output layer
