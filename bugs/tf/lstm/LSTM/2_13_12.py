...
# lstm hidden layer
    x = keras.layers.Embedding(input_dim=100, output_dim=1494, input_length=8)(input_tensor)
    x = keras.layers.LSTM(units=16, activation='sigmoid', dropout=0.11007229152811082, recurrent_dropout=-0.7060216938521221)(x)
# lstm output layer
