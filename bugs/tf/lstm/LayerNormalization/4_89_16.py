...
# lstm hidden layer
    ...
    x = keras.layers.LSTM(units=16, activation='sigmoid', implementation=606)(x)
    x = keras.layers.Dropout(rate=0.2222073456243272)(x)
    x = keras.layers.LayerNormalization(epsilon=0.0)(x)
# lstm output layer
