...
# googlenet hidden layer
    ...
    x = keras.layers.Conv2D(filters=64, kernel_size=1, strides=1, padding="same", activation="swish")(x)
    x = keras.layers.LayerNormalization(beta_initializer="zeros", epsilon=0.0)(x)
