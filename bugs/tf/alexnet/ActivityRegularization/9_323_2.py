...
# alexnet hidden layer
    ...
    x = keras.layers.Conv2D(filters=256, kernel_size=(3,3), activation='relu', padding='same', strides=1)(x)
    x = keras.layers.SpatialDropout2D(rate=0.6478302143516126)(x)
    x = keras.layers.AveragePooling2D(pool_size=(1,1), strides=2)(x)
    x = keras.layers.ActivityRegularization(l2=0.3071935272932069, l1=-0.7553701549378767)(x)
