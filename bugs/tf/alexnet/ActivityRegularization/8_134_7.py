...
# alexnet hidden layer
    ...
    x = keras.layers.Conv2D(filters=256, kernel_size=(3,3), activation='relu', padding='same', strides=[6, 3])(x)
    x = keras.layers.ActivityRegularization(l1=0.6033188117958366, l2=-0.49315341613082075)(x)
