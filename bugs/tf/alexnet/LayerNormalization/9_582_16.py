...
# alexnet hidden layer
    ...
    x = keras.layers.ReLU(threshold=0.6601605996282104)(x)
    x = keras.layers.AveragePooling2D(pool_size=(1,1), strides=(1, 5))(x)
    x = keras.layers.LayerNormalization(center=True, epsilon=0.0)(x)
