...
class alexnet(nn.Module):
    def __init__(self):
        ...
        self.pool1_mutated = jittor.nn.AvgPool2d(kernel_size=3, stride=(3, 5))
        self.conv2_mutated = jittor.nn.Tanh()
        self.relu2_mutated = jittor.nn.ReLU6()
        self.pool2_mutated = jittor.nn.ReflectionPad2d(padding=8)
