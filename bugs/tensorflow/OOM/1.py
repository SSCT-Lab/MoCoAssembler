...
# lenet hidden layer
    ...
    x = keras.layers.Conv2D(filters=2048, kernel_size=5, strides=1, activation="relu", padding="valid")(x)
    x = keras.layers.Cropping2D(cropping=2)(x)
    x = keras.layers.ActivityRegularization(l1=0.8228542050851093, l2=-0.24820400354207683)(x)
    x = keras.layers.Conv2D(filters=2048, kernel_size=5, strides=1)(x)
# lenet output layer
