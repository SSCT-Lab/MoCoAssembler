                ...
                if 'init' in lines[i]:
                    ...
                    while 'def' not in lines[index]:
                        if 'self.' in lines[index] and 'Seq' not in lines[index]:  # analyse this line in dict
                            ...
                            index = index + 1
                            seq_list = []
                            while 'jittor.nn.' in lines[index] or 'ConvBNReLU' in lines[index] or 'InceptionV3Module' in lines[index] or 'SeparableConv2d' in lines[index] or 'nn.' in lines[index]:
