...
class Xception(nn.Module):
    def __init__(self, num_classes=1000):
        ...
        self.conv1 = jittor.nn.Conv2d(in_channels=3, out_channels=32, kernel_size=3, stride=2, padding=0, bias=False)
        self.bn1 = jittor.nn.BatchNorm2d(num_features=32)
        self.relu = jittor.nn.ReLU()

        self.conv2 = jittor.nn.Conv2d(in_channels=32, out_channels=64, kernel_size=3, bias=False)
        self.bn2 = jittor.nn.BatchNorm2d(num_features=64)
        # do relu here
        ...
        self.bn3 = jittor.nn.BatchNorm2d(num_features=1536)

        # do relu here
        self.conv4 = SeparableConv2d(1536, 2048, 3, 1, 1)
        self.bn4 = jittor.nn.BatchNorm2d(num_features=2048)

        self.fc = jittor.nn.Linear(in_features=2048, out_features=1000)
