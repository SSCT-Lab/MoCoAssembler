...
def go():
    ...
    x_test = imagenet["x_test"][101:150]
    y_test = imagenet["y_test"][101:150]

    model = densenet(1000, (224, 224, 3))
    model.compile(optimizer=tf.keras.optimizers.legacy.SGD(learning_rate=0.3), loss="sparse_categorical_crossentropy",
                  metrics=["accuracy"])
