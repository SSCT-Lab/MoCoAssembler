...
# lenet hidden layer
    ...
    x = keras.layers.Cropping2D(cropping=(1, 3))(x)
    x = keras.layers.Conv2D(filters=32, kernel_size=5, activation="relu", padding="same", dilation_rate=6)(x)
    x = keras.layers.MaxPool2D(pool_size=2, strides=(1, 3))(x)
# lenet output layer
